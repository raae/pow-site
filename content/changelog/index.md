...
- **Cycle length prediction stuck after a long gap**  
  POW! now predicts your cycle length from your six most recent cycles, ignoring one-off extremes, instead of averaging every cycle ever logged. A long gap — for example around pregnancy — no longer skews the prediction for months, and predictions adjust as soon as your body settles into a new rhythm. The timeline now also talks about your "typical" cycle instead of your "average" one.
